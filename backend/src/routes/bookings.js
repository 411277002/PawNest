...
router.get('/time-blocks', authRequired, allowRoles('admin', 'staff', 'groomer', 'reception'), listTimeBlocks);
router.post('/time-blocks', authRequired, allowRoles('admin', 'staff', 'groomer', 'reception'), createTimeBlock);
router.delete('/time-blocks/:id', authRequired, allowRoles('admin', 'staff', 'groomer', 'reception'), deleteTimeBlock);
...
router.patch('/:id/status', authRequired, allowRoles('admin', 'staff', 'groomer', 'reception'), updateBookingStatus);
